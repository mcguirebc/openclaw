...
type CreateTelegramWebhookHandler =
  typeof import("../../telegram/webhook.js").createTelegramWebhookHandler;
...
export type PluginRuntime = {
  ...
  channel: {
    ...
    telegram: {
      ...
      createTelegramWebhookHandler: CreateTelegramWebhookHandler;
